#include <stdio.h>
void ComputeGrades(int*, int*, int*);
...
int main(){
    ...
    ComputeGrades(&projectGrade, &totalAss, &totalExam);    
    return 0;
}

void ComputeGrades(int* projectGrade, int* totalAss, int* totalExam) {
    ...
    //Final Grades
    float finalGrade = (0.40 * ave_projectGrade) + (0.30 * ave_assignments) + (0.30 * ave_majorExams);
